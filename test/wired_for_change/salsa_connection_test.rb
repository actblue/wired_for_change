...
describe SalsaConnection do
      ...
      before do
        ...
        @http_connection
          ...
          .with(
            ...
            "email=foo%40example.com&password=supersekrit"
          )
      ...
      describe "good creds" do
        ...
        describe "assertive" do
          ...
          it "should set session_cookie" do
            assert_equal @connection.instance_variable_get(:@session_cookie),
                         SESSION_KEY
          end
        end
        describe "post a supporter assertive" do
          ...
          it "should leave raw_post_request" do
            assert_equal @connection.raw_post_request,
                         "xml=xml&object=supporter&Email=foo%40example.com"
          end
        end
      end
      ...
      describe "bad creds" do
        ...
        describe "connect assertive" do
          before do
            _ {
              @connection.connect!
            }.must_raise SalsaConnection::AuthenticationFailure
          end
  ...
  describe "combo encoding" do
    ...
    it "should encode an array" do
      encoded =
        SalsaConnection.new({}).uri_encode(
          [[:xml, "xml"], @supporter, @donation]
        )
      assert_equal "xml=xml&object=supporter&Email=foo%40bar.com&tag=foo&tag=bar%20bas&object=donation&Email=foo%40bar.com&amount=12.34",
                   encoded
    end
  end
end
