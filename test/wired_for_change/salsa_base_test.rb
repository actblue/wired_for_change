...
describe SalsaObject do
  before do
    @object = SalsaObject.new()
  end

  describe '#uri_encode' do
    it 'should encode a hash' do
      params = { email: 'foo@bar.com', tag: ['foo', 'bar bas'] }
      @object.uri_encode(params).must_equal "email=foo%40bar.com&tag=%5B%22foo%22%2C%20%22bar%20bas%22%5D"
    end

    it 'should encode an array of two strings' do
      params = ['email', 'foo@bar.com']
      @object.uri_encode(params).must_equal "email=foo%40bar.com"
    end
    ...
    it 'should encode an array of pairs' do
      ...
      @object.uri_encode(params).must_equal "email=foo%40bar.com&single_tag=tag"
    end
    ...
    it 'should encode a SalsaObject' do
      ...
      @object.uri_encode(params).must_equal "object=subclass&tag=foo&tag=bar%20bas&Email=foo%40bar.com"
    end
  end
end
