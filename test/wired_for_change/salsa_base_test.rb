...
describe SalsaObject do
  ...
  describe '#uri_encode' do
    it 'should encode a hash' do
      ...
      assert_equal "email=foo%40bar.com&tag=%5B%22foo%22%2C%20%22bar%20bas%22%5D", @object.uri_encode(params)
    end
    ...
    it 'should encode an array of pairs' do
      ...
      assert_equal "email=foo%40bar.com&single_tag=tag", @object.uri_encode(params)
    end
    ...
    it 'should encode a SalsaObject' do
      ...
      assert_equal "object=subclass&tag=foo&tag=bar%20bas&Email=foo%40bar.com", @object.uri_encode(params)
    end
  end
end
